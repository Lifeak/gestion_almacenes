...
var ModeloCreateCmp = (function () {
    function ModeloCreateCmp(fb, router, _routeParams, _userService, _loginService, _modeloService) {
        this.router = router;
    ...
    ModeloCreateCmp.prototype.gventas = function () {
        this.router.navigate(['/ListVentas']);
    };
    ModeloCreateCmp.prototype.gdevoluciones = function () {
        this.router.navigate(['/ListDevoluciones']);
    };
    ModeloCreateCmp.prototype.ggarantiasp = function () {
        this.router.navigate(['/ListGarantiaP']);
    };
    ModeloCreateCmp.prototype.gsegsalidas = function () {
        this.router.navigate(['/ListSegSalidas']);
    };
    ModeloCreateCmp.prototype.gcontrolcalidad = function () {
        this.router.navigate(['/ListControlCalidad']);
    };
    ModeloCreateCmp.prototype.greparaciones = function () {
        this.router.navigate(['/ListReparaciones']);
    };
    ModeloCreateCmp.prototype.gpedidocompras = function () {
        this.router.navigate(['/ListCompras']);
    };
    ModeloCreateCmp.prototype.gtransportes = function () {
    ...
    ModeloCreateCmp.prototype.getProfile = function (name) {
        var _this = this;
        this._userService
            .getProfile(name)
    ...
    ModeloCreateCmp = __decorate([
        ...
        __metadata('design:paramtypes', [common_1.FormBuilder, router_1.Router, router_1.RouteParams, user_service_1.UserService, login_service_1.LoginService, modelo_service_1.ModeloService])
    ], ModeloCreateCmp);
