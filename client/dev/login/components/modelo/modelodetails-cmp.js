...
var ModeloDetailsCmp = (function () {
    function ModeloDetailsCmp(fb, router, _routeParams, _userService, _modeloService, _loginService) {
        this.router = router;
    ...
    ModeloDetailsCmp.prototype.getProfile = function (name) {
        var _this = this;
        this._userService
            .getProfile(name)
    ...
    ModeloDetailsCmp.prototype.gventas = function () {
        this.router.navigate(['/ListVentas']);
    };
    ModeloDetailsCmp.prototype.gdevoluciones = function () {
        this.router.navigate(['/ListDevoluciones']);
    };
    ModeloDetailsCmp.prototype.ggarantiasp = function () {
        this.router.navigate(['/ListGarantiaP']);
    };
    ModeloDetailsCmp.prototype.gsegsalidas = function () {
        this.router.navigate(['/ListSegSalidas']);
    };
    ModeloDetailsCmp.prototype.gcontrolcalidad = function () {
        this.router.navigate(['/ListControlCalidad']);
    };
    ModeloDetailsCmp.prototype.greparaciones = function () {
        this.router.navigate(['/ListReparaciones']);
    };
    ModeloDetailsCmp.prototype.gpedidocompras = function () {
        this.router.navigate(['/ListCompras']);
    };
    ModeloDetailsCmp.prototype.gtransportes = function () {
    ...
    ModeloDetailsCmp = __decorate([
        core_1.Component({
            ...
            providers: [user_service_1.UserService, login_service_1.LoginService, modelo_service_1.ModeloService]
        }),
